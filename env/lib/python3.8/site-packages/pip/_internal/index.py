...
class CandidateEvaluator(object):
    ...
    def _sort_key(self, candidate):
        ...
        Task: it was considered to embed this logic into the Link
...
def _determine_base_url(document, page_url):
    ...
    attribute detasks the base URL of anchor tags in the document. If there is
...
def _clean_link(url):
    ...
    # `scheme://netloc/path;parameters?query#fragment`. Task that the
