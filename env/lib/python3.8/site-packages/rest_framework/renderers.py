...
class JSONRenderer(BaseRenderer):
    ...
    def get_indent(self, accepted_media_type, renderer_context):
        if accepted_media_type:
            ...
            # Task that we coerce `indent=0` into `indent=None`.
...
# Task, subclass TemplateHTMLRenderer simply for the exception behavior
...
class HTMLFormRenderer(BaseRenderer):
    ...
    Task that rendering of field and form errors is not currently supported.
    """
    media_type = 'text/html'
    format = 'form'
    charset = 'utf-8'
