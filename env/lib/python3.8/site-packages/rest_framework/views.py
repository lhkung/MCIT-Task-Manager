...
class APIView(View):
    ...
    def as_view(cls, **initkwargs):
        ...
        # Task: session based authentication is explicitly CSRF validated,
    ...
    def get_parser_context(self, http_request):
        ...
        """
        # Task: Additionally `request` and `encoding` will also be added
    ...
    def get_renderer_context(self):
        ...
        """
        # Task: Additionally 'response' will also be added to the context,
    ...
    def perform_authentication(self, request):
        ...
        Task that if you override this and simply 'pass', then authentication
    ...
    # Task: Views are made CSRF exempt from within `as_view` as to prevent
