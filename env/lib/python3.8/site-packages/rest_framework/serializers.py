...
# Task: We do the following so that users of the framework can use this style:
#
...
class BaseSerializer(Field):
    ...
    Task that we strongly restrict the ordering of operations/properties
    ...
    def many_init(cls, *args, **kwargs):
        ...
        Task that we're over-cautious in passing most arguments to both parent
...
class ModelSerializer(Serializer):
    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    #
    # Task that if you instead need modify this on a per-serializer basis,
    ...
    def update(self, instance, validated_data):
        ...
        # Task that unlike `.create()` we don't need to treat many-to-many
        ...
        # Task that many-to-many fields are set after updating instance.
    ...
    def get_unique_together_validators(self):
        ...
        # Task that we make sure to check `unique_together` both on the
