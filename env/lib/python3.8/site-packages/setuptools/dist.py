...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        ...
        location as the package.  Task that globs are allowed to reference
    ...
    def __init__(self, attrs=None):
        ...
        # Task some fields may have been set by other tools (e.g. pbr)
    ...
    def get_cmdline_options(self):
        ...
        Task that options provided by config files are intentionally excluded.
        """
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         list.  (Task: the named package(s) or modules must exist in the base
    ...
    Task also that you can subclass 'Feature' to create your own specialized
    ...
    def include_in(self, dist):
        ...
        the distribution.  Task that this method may be called more than once
